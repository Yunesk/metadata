...
QuranData.Sura = [
	...
	[],
	[0, 7, 5, 1, 'الفاتحة', "Al-Faatiha", 'El Inicio', 'Meccan'],
	[7, 286, 87, 40, 'البقرة', "Al-Baqara", 'La Vaca', 'Medinan'],
	[293, 200, 89, 20, 'آل عمران', "Aal-i-Imraan", 'La Familia De ‘Imrán', 'Medinan'],
	[493, 176, 92, 24, 'النساء', "An-Nisaa", 'La Mujer', 'Medinan'],
	[669, 120, 112, 16, 'المائدة', "Al-Maaida", 'La Mesa Servida', 'Medinan'],
	[789, 165, 55, 20, 'الأنعام', "Al-An'aam", 'Los Ganados', 'Meccan'],
	[954, 206, 39, 24, 'الأعراف', "Al-A'raaf", 'Los Lugares Elevados', 'Meccan'],
	[1160, 75, 88, 10, 'الأنفال', "Al-Anfaal", 'Los Botines', 'Medinan'],
	[1235, 129, 113, 16, 'التوبة', "At-Tawba", 'El Arrepentimiento', 'Medinan'],
	[1364, 109, 51, 11, 'يونس', "Yunus", 'Jonás', 'Meccan'],
	[1473, 123, 52, 10, 'هود', "Hud", 'Hud', 'Meccan'],
	[1596, 111, 53, 12, 'يوسف', "Yusuf", 'José', 'Meccan'],
	[1707, 43, 96, 6, 'الرعد', "Ar-Ra'd", 'El Trueno', 'Medinan'],
	[1750, 52, 72, 7, 'ابراهيم', "Ibrahim", 'Abraham', 'Meccan'],
	[1802, 99, 54, 6, 'الحجر', "Al-Hijr", 'Al Hiyr', 'Meccan'],
	[1901, 128, 70, 16, 'النحل', "An-Nahl", 'Las Abejas', 'Meccan'],
	[2029, 111, 50, 12, 'الإسراء', "Al-Israa", 'El Viaje Nocturno', 'Meccan'],
	[2140, 110, 69, 12, 'الكهف', "Al-Kahf", 'La Caverna', 'Meccan'],
	[2250, 98, 44, 6, 'مريم', "Maryam", 'María', 'Meccan'],
	[2348, 135, 45, 8, 'طه', "Taa-Haa", 'Ta’ Ha’', 'Meccan'],
	[2483, 112, 73, 7, 'الأنبياء', "Al-Anbiyaa", 'Los Profetas', 'Meccan'],
	[2595, 78, 103, 10, 'الحج', "Al-Hajj", 'La Peregrinación', 'Medinan'],
	[2673, 118, 74, 6, 'المؤمنون', "Al-Muminoon", 'Los Creyentes', 'Meccan'],
	[2791, 64, 102, 9, 'النور', "An-Noor", 'La Luz', 'Medinan'],
	[2855, 77, 42, 6, 'الفرقان', "Al-Furqaan", 'El Criterio', 'Meccan'],
	[2932, 227, 47, 11, 'الشعراء', "Ash-Shu'araa", 'Los Poetas', 'Meccan'],
	[3159, 93, 48, 7, 'النمل', "An-Naml", 'Las Hormigas', 'Meccan'],
	[3252, 88, 49, 8, 'القصص', "Al-Qasas", 'Los Relatos', 'Meccan'],
	[3340, 69, 85, 7, 'العنكبوت', "Al-Ankaboot", 'La Araña', 'Meccan'],
	[3409, 60, 84, 6, 'الروم', "Ar-Room", 'Los Bizantinos', 'Meccan'],
	[3469, 34, 57, 3, 'لقمان', "Luqman", 'Luqmán', 'Meccan'],
	[3503, 30, 75, 3, 'السجدة', "As-Sajda", 'La Prosternación', 'Meccan'],
	[3533, 73, 90, 9, 'الأحزاب', "Al-Ahzaab", 'Los Aliados', 'Medinan'],
	[3606, 54, 58, 6, 'سبإ', "Saba", 'Saba', 'Meccan'],
	[3660, 45, 43, 5, 'فاطر', "Faatir", 'El Originador', 'Meccan'],
	[3705, 83, 41, 5, 'يس', "Yaseen", 'Iá’ Sín', 'Meccan'],
	[3788, 182, 56, 5, 'الصافات', "As-Saaffaat", 'Los Ordenados En Filas', 'Meccan'],
	[3970, 88, 38, 5, 'ص', "Saad", 'Sad', 'Meccan'],
	[4058, 75, 59, 8, 'الزمر', "Az-Zumar", 'Los Grupos', 'Meccan'],
	[4133, 85, 60, 9, 'غافر', "Al-Ghaafir", 'El Perdonador', 'Meccan'],
	[4218, 54, 61, 6, 'فصلت', "Fussilat", 'La Descripción Detallada', 'Meccan'],
	[4272, 53, 62, 5, 'الشورى', "Ash-Shura", 'La Consulta', 'Meccan'],
	[4325, 89, 63, 7, 'الزخرف', "Az-Zukhruf", 'Los Adornos', 'Meccan'],
	[4414, 59, 64, 3, 'الدخان', "Ad-Dukhaan", 'El Humo', 'Meccan'],
	[4473, 37, 65, 4, 'الجاثية', "Al-Jaathiya", 'La Arrodillada', 'Meccan'],
	[4510, 35, 66, 4, 'الأحقاف', "Al-Ahqaf", 'Las Dunas', 'Meccan'],
	[4545, 38, 95, 4, 'محمد', "Muhammad", 'Mujámmad', 'Medinan'],
	[4583, 29, 111, 4, 'الفتح', "Al-Fath", 'La Victoria', 'Medinan'],
	[4612, 18, 106, 2, 'الحجرات', "Al-Hujuraat", 'Las Moradas', 'Medinan'],
	[4630, 45, 34, 3, 'ق', "Qaaf", 'Qaf', 'Meccan'],
	[4675, 60, 67, 3, 'الذاريات', "Adh-Dhaariyat", 'Los Vientos', 'Meccan'],
	[4735, 49, 76, 2, 'الطور', "At-Tur", 'El Monte', 'Meccan'],
	[4784, 62, 23, 3, 'النجم', "An-Najm", 'La Estrella', 'Meccan'],
	[4846, 55, 37, 3, 'القمر', "Al-Qamar", 'La Luna', 'Meccan'],
	[4901, 78, 97, 3, 'الرحمن', "Ar-Rahmaan", 'El Compasivo', 'Medinan'],
	[4979, 96, 46, 3, 'الواقعة', "Al-Waaqia", 'El Suceso', 'Meccan'],
	[5075, 29, 94, 4, 'الحديد', "Al-Hadid", 'El Hierro', 'Medinan'],
	[5104, 22, 105, 3, 'المجادلة', "Al-Mujaadila", 'La Que Reclama', 'Medinan'],
	[5126, 24, 101, 3, 'الحشر', "Al-Hashr", 'El Encuentro', 'Medinan'],
	[5150, 13, 91, 2, 'الممتحنة', "Al-Mumtahana", 'La Comprobación', 'Medinan'],
	[5163, 14, 109, 2, 'الصف', "As-Saff", 'Las Filas', 'Medinan'],
	[5177, 11, 110, 2, 'الجمعة', "Al-Jumu'a", 'El Viernes', 'Medinan'],
	[5188, 11, 104, 2, 'المنافقون', "Al-Munaafiqoon", 'Los Hipócritas', 'Medinan'],
	[5199, 18, 108, 2, 'التغابن', "At-Taghaabun", 'El Día Del Desengaño', 'Medinan'],
	[5217, 12, 99, 2, 'الطلاق', "At-Talaaq", 'El Divorcio', 'Medinan'],
	[5229, 12, 107, 2, 'التحريم', "At-Tahrim", 'La Prohibición', 'Medinan'],
	[5241, 30, 77, 2, 'الملك', "Al-Mulk", 'El Reino', 'Meccan'],
	[5271, 52, 2, 2, 'القلم', "Al-Qalam", 'La Pluma', 'Meccan'],
	[5323, 52, 78, 2, 'الحاقة', "Al-Haaqqa", 'La Exposición De La Verdad', 'Meccan'],
	[5375, 44, 79, 2, 'المعارج', "Al-Ma'aarij", 'Las Vías De Ascensión', 'Meccan'],
	[5419, 28, 71, 2, 'نوح', "Nooh", 'Noé', 'Meccan'],
	[5447, 28, 40, 2, 'الجن', "Al-Jinn", 'Los Yinn', 'Meccan'],
	[5475, 20, 3, 2, 'المزمل', "Al-Muzzammil", 'El Arropado', 'Meccan'],
	[5495, 56, 4, 2, 'المدثر', "Al-Muddaththir", 'El Envuelto En Un Manto', 'Meccan'],
	[5551, 40, 31, 2, 'القيامة', "Al-Qiyaama", 'La Resurrección', 'Meccan'],
	[5591, 31, 98, 2, 'الانسان', "Al-Insaan", 'El Ser Humano', 'Medinan'],
	[5622, 50, 33, 2, 'المرسلات', "Al-Mursalaat", 'Los Que Son Enviados', 'Meccan'],
	[5672, 40, 80, 2, 'النبإ', "An-Naba", 'La Noticia', 'Meccan'],
	[5712, 46, 81, 2, 'النازعات', "An-Naazi'aat", 'Los Ángeles Arrancadores', 'Meccan'],
	[5758, 42, 24, 1, 'عبس', "Abasa", 'El Ceño', 'Meccan'],
	[5800, 29, 7, 1, 'التكوير', "At-Takwir", 'El Arrollamiento', 'Meccan'],
	[5829, 19, 82, 1, 'الإنفطار', "Al-Infitaar", 'La Ruptura', 'Meccan'],
	[5848, 36, 86, 1, 'المطففين', "Al-Mutaffifin", 'Los Tramposos', 'Meccan'],
	[5884, 25, 83, 1, 'الإنشقاق', "Al-Inshiqaaq", 'El Resquebrajamiento', 'Meccan'],
	[5909, 22, 27, 1, 'البروج', "Al-Burooj", 'Las Grandes Constelaciones', 'Meccan'],
	[5931, 17, 36, 1, 'الطارق', "At-Taariq", 'El Astro Nocturno', 'Meccan'],
	[5948, 19, 8, 1, 'الأعلى', "Al-A'laa", 'El Altísimo', 'Meccan'],
	[5967, 26, 68, 1, 'الغاشية', "Al-Ghaashiya", 'El Día Que Todo Lo Alcanza', 'Meccan'],
	[5993, 30, 10, 1, 'الفجر', "Al-Fajr", 'La Aurora', 'Meccan'],
	[6023, 20, 35, 1, 'البلد', "Al-Balad", 'La Ciudad', 'Meccan'],
	[6043, 15, 26, 1, 'الشمس', "Ash-Shams", 'El Sol', 'Meccan'],
	[6058, 21, 9, 1, 'الليل', "Al-Lail", 'La Noche', 'Meccan'],
	[6079, 11, 11, 1, 'الضحى', "Ad-Dhuhaa", 'El Resplandor Matinal', 'Meccan'],
	[6090, 8, 12, 1, 'الشرح', "Ash-Sharh", 'El Sosiego', 'Meccan'],
	[6098, 8, 28, 1, 'التين', "At-Tin", 'La Higuera', 'Meccan'],
	[6106, 19, 1, 1, 'العلق', "Al-Alaq", 'La Célula Embrionaria', 'Meccan'],
	[6125, 5, 25, 1, 'القدر', "Al-Qadr", 'La Predestinación', 'Meccan'],
	[6130, 8, 100, 1, 'البينة', "Al-Bayyina", 'La Evidencia Clara', 'Medinan'],
	[6138, 8, 93, 1, 'الزلزلة', "Az-Zalzala", 'El Terremoto', 'Medinan'],
	[6146, 11, 14, 1, 'العاديات', "Al-Aadiyaat", 'Los Corceles', 'Meccan'],
	[6157, 11, 30, 1, 'القارعة', "Al-Qaari'a", 'El Evento Repentino', 'Meccan'],
	[6168, 8, 16, 1, 'التكاثر', "At-Takaathur", 'El Afán De Tener Más Y Más', 'Meccan'],
	[6176, 3, 13, 1, 'العصر', "Al-Asr", 'El Tiempo', 'Meccan'],
	[6179, 9, 32, 1, 'الهمزة', "Al-Humaza", 'El Difamador', 'Meccan'],
	[6188, 5, 19, 1, 'الفيل', "Al-Fil", 'El Elefante', 'Meccan'],
	[6193, 4, 29, 1, 'قريش', "Quraish", 'La Tribu De Quraish', 'Meccan'],
	[6197, 7, 17, 1, 'الماعون', "Al-Maa'un", 'La Ayuda Mínima', 'Meccan'],
	[6204, 3, 15, 1, 'الكوثر', "Al-Kawthar", 'La Abundancia', 'Meccan'],
	[6207, 6, 18, 1, 'الكافرون', "Al-Kaafiroon", 'Los Incrédulos', 'Meccan'],
	[6213, 3, 114, 1, 'النصر', "An-Nasr", 'El Socorro', 'Medinan'],
	[6216, 5, 6, 1, 'المسد', "Al-Masad", 'Las Fibras De Palmera', 'Meccan'],
	[6221, 4, 22, 1, 'الإخلاص', "Al-Ikhlaas", 'El Monoteísmo Puro', 'Meccan'],
	[6225, 5, 20, 1, 'الفلق', "Al-Falaq", 'El Amanecer', 'Meccan'],
	[6230, 6, 21, 1, 'الناس', "An-Naas", 'Los Seres Humanos', 'Meccan'],
	[6236, 1]
];
